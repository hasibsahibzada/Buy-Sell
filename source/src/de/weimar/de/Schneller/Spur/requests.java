...
public class requests extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.requests);   // sets the content of first from first.xml
        ...
        this.getallpurchases = (ListView) this.findViewById(R.id.all_request_list);


        new GetAllRequests().execute(new ApiConnector());
	    ...
	    private class GetAllRequests extends AsyncTask<ApiConnector,Long,JSONArray>
	    {
	        @Override
	        protected JSONArray doInBackground(ApiConnector... params) {
	            ...
	            // it is executed on Background thread
	             ...
	             return params[0].GetAllRequests(userid);
	        }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
    	...
    	case R.id.login:
    		Intent loginintent = new Intent(requests.this,Login.class); // 
			startActivity(loginintent);
			break;
			
    	case R.id.register:
    		Intent registerintent = new Intent(requests.this,register.class); // 
			startActivity(registerintent);
			break;
			
    	case R.id.search_box:
			Intent searchintent = new Intent(requests.this,Search.class); // 
			startActivity(searchintent);
			break;
    	case R.id.help:
			Intent helpintent = new Intent(requests.this,Help.class); // 
			startActivity(helpintent);
			break;	
			
    	case R.id.sell:
			Intent sellintent = new Intent(requests.this,sell.class); // 
			startActivity(sellintent);
			break;
			
    	case R.id.Main:
			Intent mainmenuintent = new Intent(requests.this,Products.class); // 
			startActivity(mainmenuintent);
			break;
			
    	case R.id.profile:
			Intent profileintent = new Intent(requests.this,profile.class); // 
    	...
    	case R.id.logout:
			...
			Intent logoutintent = new Intent(requests.this,Products.class); // 
